...
struct syscall_entry syscalls[] = {
  ...
  [3] = {
    .name  = "read",
    .nargs = 3,
    .args  = {ARG_SOCK, ARG_STR, ARG_INT, -1, -1, -1}},
  [4] = {
    .name  = "write",
    .nargs = 3,
    .args  = {ARG_SOCK, ARG_STR, ARG_INT, -1, -1, -1}},
  ...
  [19] = {
    .name  = "lseek",
    .nargs = 3,
    .args  = {ARG_SOCK, ARG_INT, ARG_INT, -1, -1, -1}},
  [20] = {
    .name  = "getpid",
    .nargs = 0,
    .args  = {-1, -1, -1, -1, -1, -1}},
  ...
  [63] = {
    .name  = "dup2",
    .nargs = 2,
    .args  = {ARG_SOCK, ARG_SOCK, -1, -1, -1, -1}},
  [64] = {
    .name  = "getppid",
    .nargs = 0,
    .args  = {-1, -1, -1, -1, -1, -1}},
  ...
  [90] = {
    .name  = "mmap",
    .nargs = 6,
    .args  = {ARG_PTR, ARG_INT, ARG_INT, ARG_INT, ARG_SOCK, ARG_INT}},
  [91] = {
    .name  = "munmap",
    .nargs = 2,
  ...
  [180] = {
    .name  = "pread64",
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_STR, ARG_INT, ARG_INT, -1, -1}},
  [181] = {
    .name  = "pwrite64",
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_STR, ARG_INT, ARG_INT, -1, -1}},
  ...
  [187] = {
    .name  = "sendfile",
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_SOCK, ARG_PTR, ARG_INT, -1, -1}},
  [190] = {
    .name  = "vfork",
    .nargs = 0,
    .args  = {-1, -1, -1, -1, -1, -1}},
  ...
  [228] = {
    .name  = "fsetxattr",
    .nargs = 5,
    .args  = {ARG_SOCK, ARG_STR, ARG_PTR, ARG_INT, ARG_INT, -1}},
  [229] = {
    .name  = "getxattr",
    .nargs = 4,
  ...
  [231] = {
    .name  = "fgetxattr",
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_STR, ARG_PTR, ARG_INT, -1, -1}},
  [232] = {
    .name  = "listxattr",
    .nargs = 3,
    .args  = {ARG_STR, ARG_STR, ARG_INT, -1, -1, -1}},
  ...
  [251] = {
    .name  = "epoll_ctl",
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_INT, ARG_INT, ARG_PTR, -1, -1}},
  [252] = {
    .name  = "epoll_wait",
    .nargs = 4,
  ...
  [289] = {
    .name  = "send",
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_PTR, ARG_INT, ARG_INT, -1, -1}},
  [290] = {
    .name  = "sendto",
    .nargs = 6,
  ...
  [291] = {
    .name  = "recv",
    .nargs = 6,
    .args  = {ARG_SOCK, ARG_PTR, ARG_PTR, ARG_PTR, ARG_PTR, ARG_PTR}},
  [292] = {
    .name  = "recvfrom",
    .nargs = 6,
  ...
  [294] = {
    .name  = "setsockopt",
    .nargs = 5,
    .args  = {ARG_SOCK, ARG_INT, ARG_INT, ARG_STR, ARG_INT, -1}},
  [295] = {
    .name  = "getsockopt",
    .nargs = 5,
    .args  = {ARG_SOCK, ARG_INT, ARG_INT, ARG_STR, ARG_PTR, -1}},
  [296] = {
    .name  = "sendmsg",
    .nargs = 3,
    .args  = {ARG_SOCK, ARG_PTR, ARG_INT, -1, -1, -1}},
  ...
  [325] = {
    .name  = "fchownat",
    .nargs = 5,
    .args  = {ARG_SOCK, ARG_STR, ARG_INT, ARG_INT, ARG_INT, -1}},
  [326] = {
    .name  = "futimesat",
    .nargs = 3,
    .args  = {ARG_SOCK, ARG_STR, ARG_PTR, -1, -1, -1}},
  [327] = {
    .name  = "fstatat64",
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_STR, ARG_PTR, ARG_INT, -1, -1}},
  ...
  [329] = {
    .name  = "renameat",
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_STR, ARG_INT, ARG_STR, -1, -1}},
  [330] = {
    .name  = "linkat",
    .nargs = 5,
    .args  = {ARG_SOCK, ARG_STR, ARG_INT, ARG_STR, ARG_INT, -1}},
  [331] = {
    .name  = "symlinkat",
    .nargs = 3,
  ...
  [332] = {
    .name  = "readlinkat",
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_STR, ARG_STR, ARG_INT, -1, -1}},
  [333] = {
    .name  = "fchmodat",
    .nargs = 3,
    .args  = {ARG_SOCK, ARG_STR, ARG_INT, -1, -1, -1}},
  ...
  [353] = {
    ...
    .nargs = 4,
    .args  = {ARG_SOCK, ARG_INT, ARG_PTR, ARG_PTR, -1, -1}},
  [354] = {
  ...
  [358] = {
    .name  = "dup3",
    .nargs = 3,
    .args  = {ARG_SOCK, ARG_SOCK, ARG_INT, -1, -1, -1}},
  [359] = {
    .name  = "pipe2",
    .nargs = 2,
    .args  = {ARG_PTR, ARG_INT, -1, -1, -1, -1}},
  ...
  [361] = {
    .name  = "preadv",
    .nargs = 5,
    .args  = {ARG_SOCK, ARG_PTR, ARG_INT, ARG_INT, ARG_INT, -1}},
  [362] = {
    .name  = "pwritev",
    .nargs = 5,
    .args  = {ARG_SOCK, ARG_PTR, ARG_INT, ARG_INT, ARG_INT, -1}},
